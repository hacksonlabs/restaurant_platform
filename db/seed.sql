...
insert into agents (id, partner_id, name, slug, description, created_at) values
  ('agent_phantom', null, 'Phantom', 'phantom', 'Default first-party agent integration.', '2026-05-01T18:00:00.000Z'),
...
insert into operator_memberships (id, operator_user_id, restaurant_id, location_id, role, created_at) values
  ...
  ('membership_demo_rest_pizza_owner', 'op_demo_rest', 'rest_pizza_palace', 'loc_pizza_palace_main', 'owner', '2026-05-01T18:00:00.000Z'),
  ('membership_demo_rest_green_leaf_owner', 'op_demo_rest', 'rest_green_leaf_salads', 'loc_green_leaf_salads_main', 'owner', '2026-05-01T18:00:00.000Z')
on conflict (id) do update set
  operator_user_id = excluded.operator_user_id,
  restaurant_id = excluded.restaurant_id,
