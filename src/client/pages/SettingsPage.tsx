...
export function SettingsPage() {
  const { selectedRestaurantId, canManageRules, isAllRestaurantsScope } = useTenant();
  const canLoadSettings = !!selectedRestaurantId && !isAllRestaurantsScope;
  ...
  if (isAllRestaurantsScope) {
    return <div className="panel-state">Choose a restaurant to manage restaurant settings.</div>;
  }
